        ...
        <div class="card">
            ...
            <div class="card-body">
                {{--@can('Gestionar Articulos')
                    <a href="{{ url('Articulo/create') }}" title="Registrar Artículo" class="btn btn-primary"><i
                            class="fa fa-plus"></i> Registrar</a>
                @endcan--}}
                <br />
                <table class="table table-sm table-striped dt-responsive nowrap" style="width:100%" id="articulo">
                    ...
                    <tbody>
                        @foreach ($articulos as $articulo)
                            <tr>
                                ...
                                <td>{{ $articulo->nombre_cat }}</td>
                                <td>{{ $articulo->fecha_registro }}</td>
                                <td>

                                    <a href="{{ url('/Articulo/' . $articulo->id) }}"
                                        class="btn btn-info fas fa-file-alt" title="Detalles de artículo"></a>
    ...
    <script>
        $('#articulo').DataTable({
            ...
            buttons: [{
                    ...
                    filename: 'Reporte_Articulo_ACDTESC_PDF',
