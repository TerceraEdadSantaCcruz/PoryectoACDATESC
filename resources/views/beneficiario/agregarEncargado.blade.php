        ...
        <section class="formulario">
            <form action="{{ url('/encargado') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <input type="text" class="form-control" name="beneficiario_id" value="{{ $id }}"
                        id="beneficiario_id" hidden>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="date" class="form-control" name="Fecha_Nacimiento_Encargado"
                            ...
                            min="1900-01-01" max="2020-01-01" id="Fecha_Nacimiento_Encargado" required>
                    </div>
                ...
                <div class="col-12" style="text-align:right;">
                    <button type="submit" class="btn btn-primary" title="Guardar"><i class="far fa-save"></i>
                        Guardar</button>
                    <a class="btn btn-secondary" href="{{ url('beneficiario/' . $id . '/mostrarEncargado') }}"
                        title="Regresar"><i class="fas fa-arrow-circle-left"></i> Regresar</a>
                </div>
