            ...
            <form action={{ url('/Articulo') }} method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" name="descripcion"
                            ...
                            id="descripcion" placeholder="Ingrese una descripcion ...">
                    </div>
                </div>

                <div class="row">
                    <div class="form-group col-md-6">
                        <input type="text" class="form-control" name="inventario_id" value="{{ $inv_id }}"
                ...
                <div class="col-12" style="text-align:right;">
                    <button type="submit" class="btn btn-primary" title="Guardar"><i class="far fa-save"></i>
                        Guardar</button>
                    <a class="btn btn-secondary" href="{{ url('/inventario/' . $inv_id . '/mostrarArticulo') }}"
