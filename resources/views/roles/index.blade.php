...
@section('content')
    <div class="container">
        ...
        <div class="card">
            ...
            <div class="card-body">
                @can('Gestionar Roles')
                    <a class="btn btn-primary" href="{{ route('roles.create') }}" title="Registrar Roles y Permisos">
                        <i class="fa fa-plus"></i> Registar
                    </a>
                @endcan
                <table class="table table-striped table-bordered dt-responsive nowrap" style="width:100%" id="roles">
                                ...
                                <td>
                                    ...
                                    @can('Gestionar Roles')
                                        <a href="{{ route('roles.show', [$role->id]) }}" class='btn btn-info'
                                            title="Detalles de Roles y Permisos">
    ...
    <script>
        $('#roles').DataTable({
            ...
            buttons: [{
                    ...
                    exportOptions: {
                        columns: [1, 2, 3, 4, 5, 6, 9, 10, 11, 12],
                        search: 'applied',
                        order: 'applied'
                    },
