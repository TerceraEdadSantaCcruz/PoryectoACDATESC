        ...
        <div class="card">
            ...
            <div class="card-body">
                @can('Gestionar Usuarios')
                    <a class="btn btn-primary" href="{{ route('users.create') }}" title="Registrar Usuario">
                        <i class="fa fa-plus"></i> Registrar
                    </a>
                @endcan
                <table class="table table-striped table-bordered dt-responsive nowrap" style="width:100%" id="usuarios">
                                ...
                                <td width="120">
                                    ...
                                    @if ($user->status == 1)
                                        <a href="{{ route('users.status.update', ['user_id' => $user->id, 'status_code' => 0]) }}"
                                            class='btn btn-danger m-2' title="Bloquear Usuario">
